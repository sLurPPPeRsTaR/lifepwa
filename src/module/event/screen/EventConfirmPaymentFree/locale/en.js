export default {
    ...
    gratisProduk: "1 Month of lifeSaver",
    potonganHarga: "Discounts",
    durasiProteksiValue: "1 Month",
    bulan: 'Month',
    punyaReferral: 'Have Referral Code?',
    masukkankodeReferral: 'Input Refferal Code',
    polisTidakTerbentuk: 'The policy failed to generate',
    statusVoucher: 'Voucher not found',
}
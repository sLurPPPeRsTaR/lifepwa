export default {
  cariTahu: 'Frequently Asked Question',
  bantuan: 'Help',
  tentang: 'Life by IFG',
  pencarian: 'Search',
  pencarianNull: 'Data not found',
  ajukanPertanyaan: 'Ask Question',
  kamiDisiniUntuk: 'We are here for you!',

  question1: 'What are the requirement to get LifeSAVER?',
  answer1:
  ...
  question2: 'Can I buy LifeSAVER products for other people?',
  answer2:
    'Sorry, currently LifeSAVER can only be purchased as an individual/ by yourself.',

  question3: 'Can I unsubscribe from LifeSAVER?',
  answer3:
    'You can unsubscribe at any time. And at the due of the following month, IFG Life will not charge premiums and our policy will automatically expire.',

  question4:
    'Can I change the type of Plan I Selected at the beginning of my subscription?',
  answer4:
    'Of course, you can upgrade and downgrade your policy at any time, And at the due date of the following month, IFG Life will charge the premium according to you choice. And for the new type of plan, there will be no waiting period.',
  ...
  question7:
    'What is the maximum benefits for the cost of the treatment due to an accident?',
  answer7:
  ...
  answer8: (
    <>
      Yes, that’s right
      <br />
      <br /> After you register, the application will display an e-card that you
      can use when you have to go to the hospital due to an accident or
      sports/travel injury.
      <br />
      <br />
      By claiming cashless you will get the maximum benefit.
    </>
  ),
  questionBtnListRs: '[LIST OF HOSPITAL PROVIDER]',
  ...
  question10: 'Can a claim be made with a reimbursement method?',
  answer10:
  ...
  question11: 'What is Emergency transportation?',
  answer11:
    'If the Insured is in an Emergency condition/needs immediate medical action and avoid disability caused by an accident, IFG Life will provide services through a service provider to transfer the Insured from the scene of the incident to the nearest medical facility using Grouund Ambulance.',

  question12: 'How to create Life by IFG account?',
  answer12:
  ...
  question13: 'How do I login to Life by IFG?',
  answer13: 'Tap Login button on Home or Profile page.',

  question14: 'How do I connect my policy?',
  answer14:
  ...
  question15: 'Lost or forgotten password?',
  answer15:
  ...
  question16: 'How to change my password?',
  answer16:
  ...
  question17: 'How to change language?',
  answer17:

export default {
  cariTahu: 'Cari Tahu Tentang',
  bantuan: 'Bantuan',
  tentang: 'Life by IFG',
  pencarian: 'Pencarian',
  pencarianNull: 'Hasil pencarian tidak ditemukan',
  ajukanPertanyaan: 'Ajukan Pertanyaan',

  question1: 'Apa saja persyaratan untuk mendapatkan produk LifeSAVER?',
  answer1:
  ...
  question2: 'Apakah saya dapat membelikan produk LifeSAVER untuk orang lain?',
  answer2: 'Saat ini produk LifeSAVER dapat dibeli untuk diri sendiri',

  question3: 'Apakah saya bisa berhenti berlangganan LifeSAVER?',
  answer3:
  ...
  question5: 'Apakah Polis dapat langsung digunakan pada saat Polis terbit?',
  answer5:
  ...
  answer6:
    'Kecelakaan adalah suatu kejadian yang terjadi secara tiba-tiba dan tidak terduga, tanpa ada nya unsur-unsur kesengajaan. Sedangkan, cedera adalah Ketika tertanggung mengalami Cedera saat melakukan ativitas Olahraga, Perjalanan/Trip, atau Adventure, yang memerlukan Secara Medis untuk menjalani pengobatan.',
  ...
  answer8: (
    <>
      ...
      <br />
      <br />
      Setelah kamu mendaftar, maka pada aplikasi akan muncul e-card yang dapat
      kamu gunakan pada saat kamu harus berobat ke Rumah Sakit karena kecelakaan
      atau cedera olahraga/perjalanan.
      <br />
      <br />
      Dengan claim secara cashless kamu akan mendapatkan manfaat secara
      maksimal.'
    </>
  ),
  questionBtnListRs: '[LIST PROVIDER RUMAH SAKIT]',
  ...
  question10: 'Apakah claim dapat dilakukan secara reimbursement?',
  answer10:
  ...
  question11: 'Apa yang dimaksud dengan Emergency Transportation?',
  answer11:
    'Apabila Tertanggung mengalami kondisi Gawat Darurat/membutuhkan tindakan medis segera untuk menyelamatkan nyawa dan menghindari kecacatan yang disebabkan oleh kecelakaan, maka IFG Life akan memberikan pelayanan melalui penyedia jasa untuk memindahkan Tertanggung dari tempat kejadian ke fasilitas medis terdekat menggunakan Ground Ambulance.',

  question12: 'Bagaimana cara registrasi di Life by IFG?',
  answer12:
  ...
  question15: 'Bagaimana jika saya lupa password?',
  answer15:
  ...
  question16: 'Bagaimana cara mengganti password?',
  answer16:
  ...
  question17: 'Bagaimana cara mengubah bahasa di Life by IFG?',
  answer17:
